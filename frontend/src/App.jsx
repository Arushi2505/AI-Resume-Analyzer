...
function App() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-10 px-6 app-hero">
      <div className="w-full max-w-5xl rounded-[28px] border border-white/60 bg-white/85 backdrop-blur-xl p-10 shadow-[0_30px_60px_-30px_rgba(15,23,42,0.65)]">
          ...
          <div className="mt-8 space-y-6">
            ...
            <div className="p-8 rounded-3xl card-surface border-l-4 border-l-purple-500 bg-gradient-to-br from-purple-50/50 to-transparent">
              ...
              <div className="w-full bg-gray-200 rounded-full h-7 overflow-hidden shadow-inner">
                ...
                <div
                  className="h-7 rounded-full text-white text-center font-bold transition-all duration-500 shadow-lg"
                  style={{
                    width: `${result.ats_score}%`,
                    background: `linear-gradient(90deg, rgb(34, 197, 94), rgb(59, 130, 246))`
                  }}
                >
                  {result.ats_score}%
                </div>
